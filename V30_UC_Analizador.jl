...
study="XXSTUDYXX" #ej: PJM
year="XXYEARXX";
scenario="XXSCENARIOXX";
hydrology="XXHYDROLOGYXX";
beta_c_list=XXBETACLISTXX;
beta_r_list=XXBETARLISTXX;
delta_list=XXDELTALISTXX;
factorRE_list=XXFACTORREXX;
