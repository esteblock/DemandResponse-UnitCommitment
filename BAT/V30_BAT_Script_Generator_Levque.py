...
deltalistlist=[['(0.001)','0.001'],['(0.0036)','0.0036']]
scenariolist=['D','E']
hydrologylist=['humid','dry']
BetaRlistlist=[['(50,25,100,12.5,150)','12_150']]
BetaClistlist=[['(999999999)','inf']]
theta='1';
factorRE='(1,1.05,1.1)'
        ...
        for hydrology in hydrologylist:
            for betaRlist in BetaRlistlist:
                for betaClist in BetaClistlist:
                    ...
                    filebase=version+'_'+study[:-1]+'_'+scenario+'_'+year+'_'+hydrology+'_delta'+delta[1]
                    ...
                    fileSLURM = fileSLURM.replace('XXJNXX', study[:-1]+scenario+hydrology+delta[1])
                    #Write slurm file                    
